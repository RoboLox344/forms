...
export default function QreateRequest(){
    ...
    return <main>
        <section id="qreateReauest">
            <div className="container" style={{display:'flex', flexDirection:'column', gap:56, marginBottom:106}}>
                ...
                <Formik
                initialValues={{namePosition:'', nameVacancy:'',
                department:'', dateBegin:'', dateEnd:'',
                gender:'', education:'',typeSalary:'',
                salEnd:0, salBegin:0, region:'',
                address:'', metro:'', experience:'',
                workSchedule:'',functionalResponsibilities:'',wishes:'',
                advantage:'',weOffer:'',employmentType:''
            }}
                ...
                {({resetForm}) => <Form style={{display:'flex', flexDirection:'column', gap:32}}>
                    ...
                    <div className="btns-wp">
                        ...
                        <button className="btn-reset" onClick={() => resetForm()}>Сбросить</button>
                    </div>
